...
----
# Run directly
guix run github:hyperpolymath/bitfuckit

# Install to profile
guix profile install github:hyperpolymath/bitfuckit

# Development shell
guix develop github:hyperpolymath/bitfuckit
----
...
[source,bash]
----
guix profile upgrade bitfuckit
----
