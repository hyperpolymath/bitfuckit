...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/bitfuckit/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may email j.d.a.jewell@open.ac.uk
directly. No PGP key is published for this project at this time; if you need
encrypted transport, ask for one before sending report details.
...
- This repository (`hyperpolymath/bitfuckit`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/bitfuckit/security/advisories)
...
When using bitfuckit, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/bitfuckit/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/bitfuckit/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/bitfuckit/discussions) |
...
*Thank you for helping keep bitfuckit and its users safe.* 🛡️
