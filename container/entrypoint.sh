...
# bitfuckit container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping bitfuckit..."
...
# Examples:
#   exec /app/bitfuckit
#   exec /app/release/bin/bitfuckit start
#   exec /app/bitfuckit serve --host "${APP_HOST}" --port "${APP_PORT}"
